...
call s:hi('Identifier',                s:yellow,       '',         'none')
call s:hi('Function',                  s:orange,       '',         '')
...
call s:hi('Type',                      s:light_blue,     '',         'none')
call s:hi('StorageClass',              s:blue,       '',         'italic')
...
" }}}
 ...
 " HTML highlighting -------------------------------------------------------{{{
  ...
  call s:hi('htmlTag',            s:base2, '', '')
  call s:hi('htmlEndTag',         s:base2, '', '')
